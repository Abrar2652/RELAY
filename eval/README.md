...
## Headline Results (MSE 2020-2024, 1736 matched instances)

Score $= (1+c^*)/(1+c)$ capped to $[0,1]$; $c^*$ = official MSE best-known cost; higher is better.

| Method | 60s Avg | Δ vs NuWLS | W / L | 300s Avg | Δ vs NuWLS | W / L |
|---|---|---|---|---|---|---|
| NuWLS (previous SOTA) | 0.872 | — | — | 0.894 | — | — |
| SatLike | 0.853 | -0.019 | 75 / 250 | 0.871 | -0.023 | 42 / 266 |
| NuWLS-c | 0.869 | -0.003 | 99 / 117 | 0.893 | -0.001 | 109 / 100 |
...
| **VBS (8-solver ceiling)** | **0.896** | **+0.024** | **281 / 0** | **0.912** | **+0.018** | **243 / 0** |

Every parallel portfolio strictly dominates the single-solver SOTA at every size — hundreds of wins, zero losses.
...
results/FINAL_NUMBERS.md              — Paper-narrative summary

# Figures / tables
figures/tbl_combined.tex         — Main paper table (60s + 300s)
figures/tbl_main.tex             — Per-year-cat table
figures/tbl_h2h.tex              — Head-to-head counts vs NuWLS
...
# Paper-ready artifacts are in figures/ and results/FINAL_NUMBERS.md
```
